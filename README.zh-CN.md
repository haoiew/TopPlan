...
TopPlan 是一款开源、本地优先的 Windows 今日计划与 Markdown 任务记录工具，用来写下当天安排、快速记录工作进展，并让重要事项始终留在桌面视线内。它不需要账号、云服务或复杂的项目管理配置，打开即可开始记录。

![TopPlan 双栏显示今日计划与工作记录](docs/assets/topplan-overview.png)

**[下载最新 Windows 安装包](https://github.com/haoiew/TopPlan/releases/latest)**
...
TopPlan 支持 64 位 Windows 10 及更高版本。应用需要 Microsoft Edge WebView2 Runtime，大多数新版 Windows 已自带该组件。当前安装包尚未进行代码签名，因此 Windows 可能显示未知发布者提示。
